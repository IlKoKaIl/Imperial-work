...
$projectRoot = Join-Path $workspaceRoot "aes_ctr_full_pipeline_compile_test"
...
cd /workspaces/accelerated-processing/aes_ctr_full_pipeline_compile_test
rm -rf build
mkdir build
cd build
...
$reportHtml = Join-Path $projectRoot "build\\aes_ctr_full_pipeline_compile_test.report.prj\\reports\\report.html"
$reportZip = Join-Path $projectRoot "build\\aes_ctr_full_pipeline_compile_test.report.prj\\reports\\aes_ctr_full_pipeline_compile_test_report.zip"
